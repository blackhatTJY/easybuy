...
<div class="top">
    <div class="logo"><a href="${pageContext.request.contextPath}/homepage"><img src="images/logo.png" /></a></div>
    <div class="search">
    	<form>
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
<c:if test="${id==null}">
    <div  class="un_login">还未登录！<a href="Login.jsp" style="color:#ff4e00;">马上登录</a> 查看购物车！</div></c:if>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
            	<li>
